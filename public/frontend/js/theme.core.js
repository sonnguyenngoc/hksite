			...
			**/
			contactForm : {
				...
				emptyFields : function(collection){
					...
					sortedCollection.forEach(function(el){
						...
						if(!$(el).val()){
							...
							message = "Quý khách vui lòng nhập đầy đủ mọi thông tin!\n";
				...
				minLength : function(el, len){
					...
					if(el.val().length < len) message = el[0].title + " phải có ít nhất "+len+" ký tự!\n";
			...
			subscribe : {
				...
				checkValidation : function( event ){
					...
					if(!$this.find('input').val()){
						...
						cf.showMessage("Hãy nhập email của quý khách!", $this, 'error');
