...
class PartnersControllerTest < ActionController::TestCase
  ...
  test "should create partner" do
    assert_difference('Partner.count') do
      post :create, partner: { description: @partner.description, image_url: @partner.image_url, name: @partner.name, partner_id: @partner.partner_id }
    end
  ...
  test "should update partner" do
    patch :update, id: @partner, partner: { description: @partner.description, image_url: @partner.image_url, name: @partner.name, partner_id: @partner.partner_id }
    assert_redirected_to partner_path(assigns(:partner))
  end
